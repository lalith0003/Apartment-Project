  ...
  <body>
    ...
    <nav>
      ...
      <ul class="nav__links">
        ...
        <li class="link"><a href="#book">Book Apartment</a></li>
    ...
    <section id="book"  class="section__container popular__container">
      <h2 class="section__header">Our Apartments</h2>
      <div class="popular__grid">
        <div class="popular__card">
          <img src="image/2bhkinterior.jpg" alt="popular Apartment" />
          <div class="popular__content">
            <div class="popular__card__header">
              <h4>2BHK Rooms</h4><br>
            </div>
            <!-- <p><b>Apartment Number:</b> A-1-1</p><br>
            <p><b>Status:</b> Vacant</p><br>
            <p><b>Rental Cost:</b> Rs.10,000</p><br>

            <p><b>Floor - Size:</b> 1000 Sq.Ft</p><br>

            <p><b>Advance Cost:</b> Rs.20,000</p><br>
             -->
        ...
        <div class="popular__card">
          <img src="image/3bhkinterir.jpg" alt="popular hotel" />
          <div class="popular__content">
            <div class="popular__card__header">
              <h4>3BHK Rooms</h4><br>
            </div>
            <!-- <p><b>Apartment Number:</b> A-5-1</p><br>
            <p><b>Status:</b> Vacant</p><br>
            <p><b>Rental Cost:</b> Rs.15,000</p><br>
            <p><b>Floor - Size:</b> 1500  Sq.Ft</s></p><br>
            <p><b>Advance Cost:</b> Rs.30,000</p><br> -->
    ...
    <footer id="contact" class="footer">
      <div class="section__container footer__container">
        ...
        <div class="footer__col">
          <h4>Company</h4>
          <p>About Us</p>
          <p class="link"><a href="AdminLogin.jsp">Administrative</a></p>
          <p>Blog</p>
          <p>Book</p>
          <p>Contact Us</p>
        </div>
