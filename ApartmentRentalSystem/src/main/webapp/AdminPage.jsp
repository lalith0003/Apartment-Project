  ...
  <body>
    ...
    <nav>
      ...
      <ul class="nav__links">
        ...
        <li class="link"><a href="#user">User Details</a></li>
        <li class="link"><a href="ApartmentDetails.jsp">Manage Apartment</a></li>
        <li class="link"><a href="#ad">Our Apartments</a></li>
        <li class="link"><a href="#contact">Contact Us</a></li>
      </ul>
      
      <ul class="nav__links">
        <li class="link"><a href="">Admin Log</a></li>
...
<section id="user">
    <div class="section__container usertable">
        <h2 class="section__header">User List</h2>
                ...
                <% 
                    ...
                    if (!userList.isEmpty()) {
                        for (Usermember user : userList) {
                            out.println("<tr><td>" + user.getFirstname() + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>" 
